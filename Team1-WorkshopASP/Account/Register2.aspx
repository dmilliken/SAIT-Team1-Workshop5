...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div style="margin-right: 3px; margin-left: 0px; margin-top:0px; height: 420px; z-index:2; position: absolute; top: 459px; width: 118px; left: 441px;">
        ...
        <div style="margin-left: 0px; margin-right: 0px; margin-top:0px; width: 620px; height: 420px; z-index:2; position: absolute; top: 16px; left: 122px;">
            ...
            <asp:Table runat="server" Width="500px" class="Register">
                <asp:TableRow>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtemail" ErrorMessage="Email Is Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator> </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
